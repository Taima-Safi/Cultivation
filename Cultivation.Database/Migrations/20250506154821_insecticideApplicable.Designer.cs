...
namespace Cultivation.Database.Migrations
{
    ...
    [Migration("20250506154821_insecticideApplicable")]
    partial class insecticideApplicable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cultivation.Database.Model.FertilizerApplicableMixModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<double>("CurrentDonumCount")
                        .HasColumnType("float");

                    b.Property<double>("DonumCount")
                        .HasColumnType("float");
                    ...
                    b.ToTable("FertilizerApplicableMix");
                });
            ...
            modelBuilder.Entity("Cultivation.Database.Model.FertilizerLandModel", b =>
                {
                    ...
                    b.Property<long?>("CuttingLandModelId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cultivation.Database.Model.FertilizerStoreModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cultivation.Database.Model.FertilizerTransactionModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("FertilizerTransaction");
                });
            ...
            modelBuilder.Entity("Cultivation.Database.Model.InsecticideApplicableMixModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("InsecticideApplicableMix");
                });
            ...
            modelBuilder.Entity("Cultivation.Database.Model.InsecticideStoreModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("InsecticideStore");
                });

            modelBuilder.Entity("Cultivation.Database.Model.InsecticideTransactionModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("InsecticideTransaction");
                });
            ...
            modelBuilder.Entity("Cultivation.Database.Model.RoleModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cultivation.Database.Model.TokenModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cultivation.Database.Model.UserModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cultivation.Database.Model.UserRoleModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cultivation.Database.Model.FertilizerLandModel", b =>
                {
                    b.HasOne("Cultivation.Database.Model.CuttingLandModel", null)
                        .WithMany("FertilizerLands")
                        .HasForeignKey("CuttingLandModelId");
            ...
            modelBuilder.Entity("Cultivation.Database.Model.FertilizerTransactionModel", b =>
                {
                    b.HasOne("Cultivation.Database.Model.FertilizerModel", "Fertilizer")
                        .WithMany("FertilizerTransactions")
                        .HasForeignKey("FertilizerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cultivation.Database.Model.TokenModel", b =>
                {
                    b.HasOne("Cultivation.Database.Model.UserModel", "User")
                        .WithMany("Tokens")
            ...
            modelBuilder.Entity("Cultivation.Database.Model.UserRoleModel", b =>
                {
                    b.HasOne("Cultivation.Database.Model.RoleModel", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Cultivation.Database.Model.FertilizerModel", b =>
                {
                    ...
                    b.Navigation("FertilizerStores");

                    b.Navigation("FertilizerTransactions");
                });
