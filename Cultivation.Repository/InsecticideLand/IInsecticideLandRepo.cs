...
public interface IInsecticideLandRepo
{
    ...
    Task<CommonResponseDto<List<InsecticideLandDto>>> GetAllAsync(DateTime? date, string note, double? liter, double? quantity, long? landId, long? insecticideId, int pageSize, int pageNum);
